...
function MyPage() {
  ...
  return (
    <>
      ...
      <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32 mb-10 mt-10">
        <div className="px-4 pt-8">
            ...
            {store.products
              ...
              .map((m, i) => (
                <div className="flex  rounded-lg bg-white sm:flex-row">
                  <img
                    className="m-2 h-24 min-w-28 rounded-md border object-cover object-center"
                    src={m?.main_image}
                    alt=""
                  />
                  <div className="flex w-full flex-col px-4 py-4">
                    ...
                    <p className="text-lg font-bold">${m?.normal_price}</p>
                  </div>
                </div>
              ))}
          </div>
          ...
          <form className="mt-5 grid gap-6">
            ...
            <div className="relative">
              ...
              >
                <div className="ml-5">
                  <span className="mt-2 font-semibold">Cariex Delivery</span>
                  <p className="text-slate-500 text-sm leading-6">
                    Delivery: 3-7 Days
                  </p>
                </div>
          ...
          <div className="">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <select
                type="text"
                name="billing-state"
                className=" sm:w-7/12 rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"
              >
            ...
            <div className="flex flex-col gap-3 sm:flex-row mt-3">
              <input
                type="text"
                name="billing-zip"
                className="flex-shrink-0  sm:w-6/12 rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none sm:w-1/6 focus:z-10 focus:border-blue-500 focus:ring-blue-500"
                placeholder="ZIP"
              />
              <select
                type="text"
              ...
              <div className="relative">
                ...
                >
                  <img
                    ...
                    src="https://pbs.twimg.com/profile_images/1605279612216348672/PCYJMyaB_400x400.png"
                    alt=""
                  />
                  <div className="ml-5">
                    <span className="mt-2 font-semibold">Paypal</span>
                    <p className="text-slate-500 text-sm leading-6">Global</p>
                  </div>
                </label>
              </div>
              <div className="relative">
                ...
                >
                  ...
                  />
                  <div className="ml-5">
                    <span className="mt-2 font-semibold">Mon Cash</span>
                    <p className="text-slate-500 text-sm leading-6">Haiti</p>
                  </div>
                </label>
              </div>
            </form>
